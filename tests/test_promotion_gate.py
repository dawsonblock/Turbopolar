...
class TestTurboPolarPromotionGate(unittest.TestCase):
    ...
    def test_cache_attention_payload_includes_partial_tail(self):
        ...
        self.assertEqual(
            block.radii.shape[2], 2
        )  # one full block + one padded partial block
    ...
    def test_promotion_gate_evaluation(self):
        ...
        for shape in test_shapes:
            ...
            block, quant_v, dense_v, qjl_payload, actual_len = (
        ...
        candidate_logits = (
            baseline_logits + mx.random.normal(shape=[1, 100, 32000]) * 0.0001
        )
        ...
        shootout_results = {
            ...
            "validation_status": {
                ...
                "metal_kernel_compiles_passed": True
        ...
        self.assertTrue(
            math_validated, "Math validation failed against dense reference."
        )
