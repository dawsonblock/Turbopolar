    ...
    def _evidence_with_speed(self, **speed_overrides) -> PromotionEvidence:
        ...
        return PromotionEvidence(
            ...
            teacher_forced_report=TeacherForcedReport(
                ...
                raw_metrics_path="/tmp/teacher_metrics.json",
                raw_metrics_hash="sha256:abc",
            ),
            fused_decode_report=FusedDecodeReport(
                ...
                trace_artifact_path="/tmp/traces.jsonl",
                trace_artifact_hash="sha256:def",
            ),
            speed_report=speed,
            ...
            provenance=BenchmarkProvenance(
                ...
                metal_kernel_source_hash="sha256:kern",
            ),
        )
